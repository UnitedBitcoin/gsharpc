...
namespace Demo1
{
    ...
    public class ExampleLibClass
    {
        ...
        public void TestArithmeticOperators()
        {
            ...
            print("-8=" + (-a)); // -8=-8        
            print("-8=" + neg(a)); // -8=-8
            print("!true=" + (!t)); // !true=0   FIXME: 这里.net字节码把布尔当0/1 int处理  
        ...
        public void TestArray()
        {
            ...
            array1.Set(4, 2); // change to null, TODO    
                              // FIXME: %30=[1], pprint输出[%30, 1, 2,]的时候好像%30会变，似乎pprint有问题
        ...
        public void TestEmitEvent()
        {
            ...
            var a = 3;
            var b = 4;
            MyEventEmitteer.EmitHello2("" + (a + b)); // TODO: 需要在合约中测一下
        }
        ...
        public MyContract Main()
        {
            ...
            pprint(contract); // FIXME: pprint/tojsonstring 有时有点BUG
